...
**Sprint 2.6 (MVP): Каталог товаров + маппинг маркетплейсов**
- [ ] Страница `/app/products` — каталог всех внутренних товаров с колонками WB / Ozon статусов
- [ ] Визуальные индикаторы: WB ✓ зелёный / ✗ красный, Ozon ✓/✗, бейдж «Без связки»
- [ ] Фильтр «Только без связки» — показать товары без маппинга
- [ ] Инлайн-форма привязки: поле WB barcode (nmID) + Ozon offer_id, сохранение через `ProductChannelMapping`
- [ ] Раздел «Учёт остатков» переименован/упрощён; основной каталог вынесен в «Товары»
